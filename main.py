...
class MiApp(QMainWindow):
    ...
    def obtener_parametros(self):
        ...
        if self.ui.checkBox_t_fin_servicio_constante.isChecked():
            ...
            parametros["servicio"] = {
                "tipo": "uniforme",
                "min": float(self.ui.lineEdit_t_fin_servicio_min.text()),
                "max": float(self.ui.lineEdit_t_fin_servicio_max.text())
            }
    ...
    def simular(self):
        ...
        self.ui.tableWidget_tabla_sim.setHorizontalHeaderLabels()
